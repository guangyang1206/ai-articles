...
## 一、文章三轮审核规范（2026-08-17 确立）

> **每篇文章发布前必须通过至少三轮审核，且连续三轮无事实/数据错误方可定稿。** 审核不是可选项，是发布流程的硬性关卡。
...
按「数据口径铁律」（第二节第 1 条）与 AI 行业事实核查方法论执行：

- 硬事实与观点分开核；优先核查日期、金额、估值/融资、ARR/实际营收、产品发布状态、公司关系
- 优先官方信源、一手财报、可靠财经媒体；**媒体报道 ≠ 公司确认**
- 文中引用数据必须有来源标注；找不到来源的一律视为待核实
- 币种、单位、时间口径必须显式标注，不得混用
...
**解决**：生成后必跑检查脚本（见第三节第 2 条）。

### 错误 3：ARR 数据没标注，被读者挑刺

**原因**：写作时偷懒，把 ARR 直接写成了"全年营收"。

**解决**：按第二节第 1 条表格，严格区分实际营收和 ARR。
